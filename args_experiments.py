...
def args_springs():
    ...
    parser.add_argument('--save-every', type=float, default=0.02, help='Save model weights every *** sparsity level.')
    parser.add_argument('--seed', type=int, default=1234, help='Random seed.')
    parser.add_argument('--self-loops', type=bool, default=True, help='Presence of zeros on the diagonal.')
...
def args_cmapss():
    ...
    parser.add_argument('--save-every', type=float, default=0.05, help='Save model weights every *** sparsity level.')
    parser.add_argument('--seed', type=int, default=1234, help='Random seed.')
    parser.add_argument('--self-loops', type=bool, default=False, help='Presence of zeros on the diagonal.')
